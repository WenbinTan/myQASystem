...
class QuestionClassifier:
    def __init__(self):
        ...
        #　特征词路径
        self.disease_path = os.path.join(cur_dir, 'dict/disease.txt').replace('/', '\\')
        self.department_path = os.path.join(cur_dir, 'dict/department.txt').replace('/', '\\')
        self.check_path = os.path.join(cur_dir, 'dict/check.txt').replace('/', '\\')
        self.drug_path = os.path.join(cur_dir, 'dict/drug.txt').replace('/', '\\')
        self.food_path = os.path.join(cur_dir, 'dict/food.txt').replace('/', '\\')
        self.producer_path = os.path.join(cur_dir, 'dict/producer.txt').replace('/', '\\')
        self.symptom_path = os.path.join(cur_dir, 'dict/symptom.txt').replace('/', '\\')
        self.deny_path = os.path.join(cur_dir, 'dict/deny.txt').replace('/', '\\')
        # 加载特征词
